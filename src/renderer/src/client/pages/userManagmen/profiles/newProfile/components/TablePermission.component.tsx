...
import {getPermissions} from '../adapter/permissions.adapter';

const TablePermission = ({onPermissionsChange}) => {
        ...
        setRowData(prevRowData => {
            ...
            if (id.endsWith('-00') && !id.endsWith('00-00')) {
                ...
                newRowData.forEach(permiso => {
                    ...
                    if (permiso.id == `${module}00-00`) {
                        console.log('MODULO ecncontrado: ', subModuleId)
                        if (!permiso.state) {
                            console.log('MODULO activar: ', subModuleId)
